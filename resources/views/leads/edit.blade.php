        ...
        <form action="{{ route('leads.update', $lead) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_secondary" value="{{ old('phone_secondary', $lead->phone_secondary) }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <textarea name="address" rows="2"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('address', $lead->address) }}</textarea>
                    </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="budget_min" value="{{ old('budget_min', $lead->budget_min) }}" step="0.01"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Budget Max (₹)</label>
                        <input type="number" name="budget_max" value="{{ old('budget_max', $lead->budget_max) }}" step="0.01"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="property_type"
                            ...
                            <option value="apartment" {{ old('property_type', $lead->property_type) == 'apartment' ? 'selected' : '' }}>Apartment</option>
                            <option value="villa" {{ old('property_type', $lead->property_type) == 'villa' ? 'selected' : '' }}>Villa</option>
                            <option value="plot" {{ old('property_type', $lead->property_type) == 'plot' ? 'selected' : '' }}>Plot</option>
                            <option value="commercial" {{ old('property_type', $lead->property_type) == 'commercial' ? 'selected' : '' }}>Commercial</option>
                            <option value="office" {{ old('property_type', $lead->property_type) == 'office' ? 'selected' : '' }}>Office Space</option>
                        </select>
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="requirements" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('requirements', $lead->requirements) }}</textarea>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="notes" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('notes', $lead->notes) }}</textarea>
            </div>
